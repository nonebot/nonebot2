...
### _class-var_ `plugin_name` {#Matcher-plugin-name}

- **类型:** ClassVar[str | None]

- **说明:** 事件响应器所在插件名

### _class-var_ `module_name` {#Matcher-module-name}
...
- **参数**
  ...
  - `default_type_updater` ([T_TypeUpdater](typing.md#T-TypeUpdater) | [Dependent](dependencies/index.md#Dependent)[str] | None)

  - `default_permission_updater` ([T_PermissionUpdater](typing.md#T-PermissionUpdater) | [Dependent](dependencies/index.md#Dependent)[[Permission](permission.md#Permission)] | None)
